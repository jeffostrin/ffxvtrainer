...
## To run local SAM CLI
```
ffxvtrainer/clock/$ sam local start-api
```

## To run unit tests
```
ffxvtrainer/clock/clock/$ npm test
```
## To update nodejs dependencies

```
ffxvtrainer/clock/clock/$ npm install
```
