...
class MiniEvents
  ...
  HourlyEvents_STARTED_JUNE_24_LOCAL_TIME = [
    ...
    { :utc=>13, :local=>"6am", :event=>unknown },
    { :utc=>14, :local=>"7am", :event=>unknown },
    { :utc=>15, :local=>"8am", :event=>guild_quests + "(23rd)" },
    { :utc=>16, :local=>"9am", :event=>guild_rss_help + "(23rd)" },
    { :utc=>17, :local=>"10am", :event=>guild_defend + "(23rd)" },
    { :utc=>18, :local=>"11am", :event=>spin + "(23rd)" },
    { :utc=>19, :local=>"12pm", :event=>secret + "(23rd)" },
