...
class MiniEvents
  ...
  HourlyEvents_STARTED_JUNE_24_LOCAL_TIME = [
    ...
    { :utc=>15, :local=>"8am", :event=>guild_quests + "(23,24)" },
    { :utc=>16, :local=>"9am", :event=>guild_rss_help + "(23,24)" },
    { :utc=>17, :local=>"10am", :event=>guild_defend + "(23,24)" },
    { :utc=>18, :local=>"11am", :event=>spin + "(23,24)" },
    { :utc=>19, :local=>"12pm", :event=>secret + "(23,24)" },
    { :utc=>20, :local=>"1pm", :event=>hero_quests + "(23rd)" },
    { :utc=>21, :local=>"2pm", :event=>MiniEvents::GatherRSS + "(23rd)" },
    { :utc=>22, :local=>"3pm", :event=>guild_quests + "(23rd)" },
    { :utc=>23, :local=>"4pm", :event=>guild_help + "(23rd)" },
  ...
  HourlyEvents = HourlyEvents_STARTED_JUNE_24_LOCAL_TIME
